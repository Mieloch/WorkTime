...
import topworker.utils.rest.RequestHolder;
...
public class MainUI extends UI {
    ...
    public void handleLoginEvent(LoginEvent loginEvent) {
        ...
        try {
            authenticationService.handleAuthentication(loginEvent.getLogin(), loginEvent.getPassword(), RequestHolder.getRequest());
            navigator.navigateTo(WorkCalendarView.VIEW_NAME);
        } catch (BadCredentialsException exception) {
            System.out.println("NIE ZALOGOWAL");
        }
    ...
    private void initNavigator() {
        ...
        View v = viewProvider.getView("loginv");
